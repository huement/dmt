...
return [
    ...
    /**
     * Command
     * specific input / execution single responsibility
     */
    'command' => [
    ...
    /**
     * Command Controller
     * shared logic for entire command group(s)
     */
    'controller' => [
        'placeholder' => '@controllername',
        'stub' => 'controller.php',
        'output_path' => base_path('app/Controllers')
    ],

    /**
     * Provider
     * shared JIT (just in time) services / functionality / etc
     */
    'provider' => [
        'placeholder' => '@providername',
        'stub' => 'provider.php',
        'output_path' => base_path('app/Providers')
    ],
    ...
    'console' => [
        ...
        'stub' => 'console.php',
        'output_path' => base_path('app/Console')
    ],
