...
/**
 * This PHREAK Command [NoteController] provides the backend logic and scripts.
...
class NoteController
{
 ...
 public static function getNotebookData($id = 1)
 {
  ...
  $RowData = DataController::getRowByID("notebooks", $id);
...
NoteController::__constructStatic();
